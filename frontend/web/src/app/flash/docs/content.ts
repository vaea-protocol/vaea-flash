...
export const API_ENDPOINTS = [
  {
    ...
    desc: 'Returns real-time borrowing capacity for all 27 tokens. Refreshes every 2s.',
    params: [],
    response: `{
  "tokens": [{
...
export const FAQ = [
  ...
  { q: 'How is VAEA different from Jupiter Flash Loan?', a: 'Jupiter only supports tokens on Jupiter Lend. VAEA covers 27 tokens via synthetic routing — LSTs, majors, stablecoins, and mid-caps.' },

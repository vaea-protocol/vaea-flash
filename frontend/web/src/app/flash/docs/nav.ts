...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: 'supported-tokens', title: 'Supported Tokens', description: '27 tokens — direct route (8) and synthetic route (19)', icon: '🪙',
        headings: [{ id: 'direct', label: 'Direct Route (8)', level: 2 }, { id: 'synthetic', label: 'Synthetic Route (19)', level: 2 }, { id: 'lst', label: 'LSTs via Sanctum', level: 3 }, { id: 'majors', label: 'Majors via Jupiter', level: 3 }, { id: 'midcaps', label: 'Mid-caps', level: 3 }, { id: 'stables', label: 'Stablecoins', level: 3 }] },

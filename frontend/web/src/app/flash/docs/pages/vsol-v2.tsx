...
export default function VsolV2() {
  return (<>
    ...
    <Callout type="warn">vSOL V2 is <strong>in development</strong> and will launch after the V1 beta is validated. This page describes the architecture and vision. The V1 flash loan system (27 tokens via protocol aggregation) is live and fully functional today.</Callout>
...
With pool-based flash loans (current):
  ...
  Result:
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
      {[
        { phase: 'Phase 1', title: 'V1 Beta (Now)', desc: 'Flash loans via protocol aggregation — 27 tokens, 3 SDKs, live on devnet', done: true },

...
export default function SdkUtilities() {
  return (<>
    ...
    <p style={{ color: 'var(--text-2)', lineHeight: 1.8, marginBottom: 16, fontSize: '0.88rem' }}>Get capacity for a <strong>single token</strong> without loading all 27 tokens. Throws <code>TOKEN_NOT_SUPPORTED</code> if not found.</p>
    <CodeTabs
